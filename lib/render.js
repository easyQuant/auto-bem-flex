...
function render (options) {
    ...
    fs.writeFileSync(`./${ options.type }s/${ options.name }/${ options.name }.wxml`, renderWXML(options), (err) => {
    ...
    fs.writeFileSync(`./${ options.type }s/${ options.name }/${ options.name }.less`, renderLESS(options), (err) => {
    ...
    fs.writeFileSync(`./${ options.type }s/${ options.name }/${ options.name }.js`, renderJS(options), (err) => {
    ...
    fs.writeFileSync(`./${ options.type }s/${ options.name }/${ options.name }.json`, renderJSON(), (err) => {
